...
class SmartPortariaScanner(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.lbl_id_viva.setObjectName("lbl_id_viva")
    ...
    def configurar_navegadores(self):
        ...
        s_main.setAttribute(QWebEngineSettings.WebAttribute.PluginsEnabled, True)
        s_main.setAttribute(QWebEngineSettings.WebAttribute.ScrollAnimatorEnabled, True)
